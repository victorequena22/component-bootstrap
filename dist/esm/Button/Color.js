...
export function ButtonColor(_a) {
    ...
    var handleChange = function (c) { setData("#".concat(c.hex)); setColor(c); };
    var handleClick = function (event) { setOpen(event.currentTarget); if (click)
        click(); };
    ...
    return React.createElement(React.Fragment, null,
        ...
        disable ? React.createElement(React.Fragment, null) : React.createElement(Popover, { open: open, anchorEl: open, onClose: handleClose, anchorOrigin: { vertical: 'bottom', horizontal: 'left' } },
            ...
            React.createElement(RowConfig, { style: {
                ...
                } }, colores.map(function (c) { return React.createElement("div", { onClick: function () { return setData(c); }, style: { backgroundColor: c, border: '1px solid black', height: '25px' } }); }))));
}
