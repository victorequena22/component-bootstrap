...
export function TitleCard(_a) {
    ...
    return React.createElement(Row, { className: 'd-flex justify-content-center mt-1', style: { backgroundColor: '#fff', margin: '0 -3px -3px -3px', padding: '0 0 0 0', borderRadius: '0 0 .25rem .25rem' } },
...
export function CardMain(_a) {
    ...
    return React.createElement(Card, { className: className, style: { width: width, backgroundColor: '#ccc', padding: '7px 7px 7px 7px' } },
        React.createElement(Row, { style: { margin: '0 0 0 0', padding: '0 0 0 0' } },
            React.createElement(TP, { key: "tooltip".concat(Math.random()), className: css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["z-index: 99999999;"], ["z-index: 99999999;"]))), place: 'bottom' }),
            children));
}
